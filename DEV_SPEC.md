...
|---------|---------|------|---------|------|
| A1 | 初始化目录树与最小可运行入口 | [x] | 2026-02-27 | auto-coder A1 |
| A2 | 引入 pytest 并建立测试目录约定 | [x] | 2026-02-27 | auto-coder A2 |
| A3 | 配置加载与校验（Settings） | [x] | 2026-02-27 | auto-coder A3 |

#### 阶段 B：Libs 可插拔层

| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| B1 | LLM 抽象接口与工厂 | [x] | 2026-02-28 | auto-coder B1 |
| B2 | Embedding 抽象接口与工厂 | [x] | 2026-02-28 | auto-coder B2 |
| B3 | Splitter 抽象接口与工厂 | [x] | 2026-02-28 | auto-coder B3 |
| B4 | VectorStore 抽象接口与工厂 | [x] | 2026-02-28 | auto-coder B4 |
...
| B7.7 | LLM Reranker 实现 | [x] | 2026-03-03 | auto-coder B7.7 |
| B7.8 | Cross-Encoder Reranker 实现 | [x] | 2026-03-03 | auto-coder B7.8 |
| B8 | Vision LLM 抽象接口与工厂集成 | [x] | 2026-03-03 | auto-coder B8 |
| B9 | Azure Vision LLM 实现 | [x] | 2026-03-03 | auto-coder B9 |

#### 阶段 C：Ingestion Pipeline MVP

| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| C1 | 定义核心数据类型/契约（Document/Chunk/ChunkRecord） | [x] | 2026-03-08 | auto-coder C1 |
...
| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| D1 | QueryProcessor（关键词提取 + filters） | [x] | 2026-04-24 | 规则提取关键词/filter+3个单元测试 |
| D2 | DenseRetriever（调用 VectorStore.query） | [x] | 2026-04-24 | Embedding+VectorStore编排+2个单元测试 |
| D3 | SparseRetriever（BM25 查询） | [x] | 2026-04-24 | BM25→get_by_ids水合+2个单元测试 |
| D4 | RRF Fusion | [x] | 2026-04-24 | Reciprocal Rank Fusion实现+2个单元测试 |
| D5 | HybridSearch 编排 | [x] | 2026-04-24 | Query→Dense/Sparse→Fusion集成+1个集成测试 |
| D6 | Reranker（Core 层编排 + Fallback） | [x] | 2026-04-24 | 后端异常回退原排序+2个单元测试 |
| D7 | 脚本入口 query.py（查询可用） | [x] | 2026-04-24 | Query CLI+verbose/no-rerank输出+2个E2E测试 |
